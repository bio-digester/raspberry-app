...
(function() {
    ...
    function ab(m) {
        function q() {} q.prototype = m; return new q }
        ...
        if (isNaN(y)) {
            try {
                ...
                if (!qa) { var x = document.body;
                    ...
                    qa.appendChild(z);
                    x.appendChild(qa) } qa.style.display = "";
                qa.setAttribute("style", m);
                y = Math.round(qa.offsetHeight);
                qa.style.display = "none"
            } catch (R) { y = Math.ceil(1.1 * q) } y = Math.max(y, q);
            Wa[v] = y
        }
        return y
    }
    ...
    ka.prototype._getLineWithWidth = function(m, q, v) {
        ...
        for (this.ctx.font = this._getFontString(); y <= x;) { var z = Math.floor((y + x) / 2),
            ...
            else break } v > q && 1 < G.length && (G = G.substr(0, G.length - 1), v = this.ctx.measureText(G).width);
        q = !0;
    ...
    ka.prototype._wrapText = function() {
        ...
        if (0 === this.frontSize) x = y = 0;
            ...
            for (; 0 < m.length;) { var z = this.maxHeight - (this.topPadding + this.bottomPadding),
                ...
                z && y > z && (G = v.pop(), y -= G.height, x = R) } this._wrappedText = { lines: v, width: x, height: y };
    ...
    La.Chart = function() {
        ...
        function ja(a) { this.chart = a;
            ...
            this.animations = [];
            this.animationRequestId = null } oa(s, Y);
        ...
        s.prototype.render = function(a) {
            ...
            if (this.animatedRender) { var e = ua(this.width, this.height);
                e.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } db(this);
            ...
            if (0 < c.length) r.disableToolTip = !0, r._animator.animate(200, r.animationDuration, function(a) {
                ...
                r.dispatchEvent("dataAnimationIterationEnd", { chart: r }) } this.attachPlotAreaEventHandlers();
                            ...
                            if (!(4 > v.dataPoints.length))
                                for (r = 0; r < v.dataPoints.length; r++)
                                    if (c && (p = (n + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, k = v.dataPoints[r].x.getTime ? v.dataPoints[r].x.getTime() : v.dataPoints[r].x, p = Math.floor((k - h) / p), k < g[p].min &&
                                            (g[p].min = k), k > g[p].max && (g[p].max = k)), b) { var q = (t + 1 - l) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100; if ((k = "waterfall" === a.type ? v.dataPointEOs[r].cumulativeSum : v.dataPoints[r].y) && k.length)
        ...
        s.prototype.getDataPointAtXY = function(a, f, b) {
            ...
            for (var c = [], e = this._dataInRenderedOrder.length - 1; 0 <= e; e--) { var g = null;
                (g = this._dataInRenderedOrder[e].getDataPointAtXY(a, f, b)) && c.push(g) } a = null;
            f = !1;
            ...
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(b && 1 < b.length)) {
                    ...
                    try { var h = e.y - this._lastTouchData.y,
                            ...
                            l && l.scrollBy && l.scrollBy(0, -h) } } catch (t) {} this._lastTouchEventType = a.type;
        ...
        s.prototype.preparePlotArea = function() {
            ...
            if ((this.axisX[0] || this.axisX2[0]) && (this.axisY[0] || this.axisY2[0])) {
                ...
                if (this.axisY && 0 < this.axisY.length && this.axisY[0]) { var b = this.axisY[0];
                    ...
                    a.width = a.x2 - a.x1;
                    a.height = a.y2 - a.y1 } this.axisY2 && 0 < this.axisY2.length && this.axisY2[0] && (b = this.axisY2[0], a.x1 = f.x1 < f.x2 ? f.x1 : b.lineCoordinates.x1, a.y1 = f.y1 < b.lineCoordinates.y1 ? f.y1 : b.lineCoordinates.y1, a.x2 = f.x2 > b.lineCoordinates.x2 ?
        ...
        s.prototype.renderStackedArea =
            function(a) {
                function f() { if (!(1 > t.length)) { for (0 < A.lineThickness && c.stroke(); 0 < t.length;) { var a = t.pop();
                            c.lineTo(a.x, a.y);
                            v && s.lineTo(a.x, a.y) } c.closePath();
                                ...
                                if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da)))
                                    if ("number" !== typeof aa.y) A.connectNullData || (da || q) || f(), da = !0;
                                        ...
                                        if (0 <= A.dataPointIndexes[w]) { var na = A.dataPointIds[A.dataPointIndexes[w]];
                                            this._eventManager.objectMap[na] = { id: na, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: A.dataPointIndexes[w], x1: n, y1: d } } 0 <= A.dataPointIndexes[w] && 0 !== aa.markerSize &&
        ...
        s.prototype.renderStackedArea100 = function(a) {
            function f() { for (0 < A.lineThickness && c.stroke(); 0 < t.length;) { var a = t.pop();
                    c.lineTo(a.x, a.y);
                    v && y.lineTo(a.x, a.y) } c.closePath();
                c.globalAlpha = A.fillOpacity;
                c.fill();
                c.globalAlpha = 1;
                c.beginPath();
        ...
        var qa = function(a, f, b, c, e, g, h, l, t) {
            if (!(0 >
                    ...
                    Number((g % (2 * Math.PI)).toFixed(8)) === k && (h -= 1E-4) } a.save();
                    ...
                    if (0 !== z) {
                        ...
                        this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                            ...
                            for (b = 0; b < r.length; b++) { var c = 0 === b ? d[b].startAngle : e,
                                ...
                                e > c && qa(t.plotArea.ctx, d[b].center, d[b].radius, g, k.type, c, e, k.fillOpacity, d[b].percentInnerRadius); if (f) break } l()
                        }, function() {
                            t.disableToolTip = !1;
        ...
        s.prototype.renderFunnel =
            function(a) {
                        ...
                        for (k = N.length - 1; 0 < k; k--)
                            if (!F[k].isDirty) { e = p(k); if (0 > e && (e = 0, F[e].isDirty)) break; if (F[k].textBlock.y < F[e].textBlock.y + F[e].height) { d = d || k;
                                    f = k; for (h = 0; F[f].textBlock.y < F[e].textBlock.y + F[e].height + ga;) { a = a || F[f].textBlock.y + F[f].height;
                                        ...
                                        h += ga;
                                        f = e; if (0 >= f) { f = 0;
                                            h += F[f].height; break } e = p(f); if (0 > e) { f = 0;
                ...
                function q(a) {
                    ...
                    if (s.subtitles)
                        for (var b = 0; b < s.subtitles.length; b++) { var c = s.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) s.subtitles.ctx = a, c.render() } s.legend && (s.legend.dockInsidePlotArea || "center" === s.legend.horizontalAlign &&
        ...
        s.prototype.replaceKeywordsWithValue = function(a, f, b, c, e) {
            ...
            if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type || "funnel" === b.type || "pyramid" ===
                ...
                do {
                    ...
                    if (b.percentFormatString) t = b.percentFormatString;
                        ...
                        b.percentFormatString = t } a = a.replace("#percent", X(h, t, g._cultureInfo));
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var d = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    d && 0 < d.length && (h = Ga(d[2]), a = Ga(d[1])) } catch (k) {} d = null;
                    ...
                    if ("pie" !== n.type && "doughnut" !==
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var z = n.dataPoints[x],
                                ...
                                n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: z }) : z.name ? z.name : "DataPoint: " + (x + 1),
        ...
        ba.prototype.createUserOptions = function(a) {
            if ("undefined" !==
                typeof a || this.options._isPlaceholder) { var f = 0;
        ...
        ba.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (c = 1 === p % 2 ? (c.x << 0) + 0.5 : c.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c - p / 2, y1: e, x2: h + p / 2, y2: l }, this.ctx.moveTo(c,
                    ...
                    if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === p % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2,
                            h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c, y1: e - p / 2, x2: h, y2: l + p / 2 }, this.ctx.moveTo(c, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(h, e), this.ctx.lineTo(h, l), this.ctx.lineTo(c, l);
                    ...
                    this.ctx.lineTo(m + a, k + g * a) } 0 < p && this.ctx.stroke();
                this.ctx.closePath();
        ...
        oa(fa, Y);
        fa.prototype.createUserOptions = function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var f = 0;
                this.parent.options._isPlaceholder && this.parent.createUserOptions();
        ...
        fa.prototype.render = function() {
            ...
            if (0 < f) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1,
                    l = this.chart.plotArea.y2, this.bounds = { x1: e - f / 2, y1: h, x2: g + f / 2, y2: l };
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        } else h = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataPoint.y) << 0, l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : y(this.options.label) ? X(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = c = h;
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[q].type || "rangeArea" === this.parent.dataSeries[q].type || "error" === this.parent.dataSeries[q].type || "rangeSplineArea" === this.parent.dataSeries[q].type || "candlestick" === this.parent.dataSeries[q].type || "ohlc" === this.parent.dataSeries[q].type ||
                        ...
                        0, l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : y(this.options.label) ? X(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    e = g = h;
                    b = this.chart.plotArea.x1;
                    c = this.chart.plotArea.x2;
                    this.bounds = { x1: b, y1: e - k / 2, x2: c, y2: g + k / 2 };
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    ...
                    if (u) {
                        ...
                        this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" }) : y(this.options.label) ? X(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    l.x = b - l.measureText().width / 2;
                    l.x + l.width > this.chart.bounds.x2 && (l.x = this.chart.bounds.x2 - l.width);
                    l.x < this.chart.bounds.x1 && (l.x = this.chart.bounds.x1);
                    "bottom" === this.parent._position ? l.y = this.parent.lineCoordinates.y2 + l.fontSize / 2 + 2 : "top" === this.parent._position && (l.y = this.parent.lineCoordinates.y1 - l.height + l.fontSize / 2 + 2)
        ...
        ea.prototype.mouseEventHandler = function(a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                for (b = 0; b < this.mouseoveredObjectMaps.length; b++) { g = !0; for (c = 0; c < f.length; c++)
                    ...
                    g ? this.fireEvent(this.mouseoveredObjectMaps[b], "mouseout", a) : e.push(this.mouseoveredObjectMaps[b]) } this.mouseoveredObjectMaps = e;
